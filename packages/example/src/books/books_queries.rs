...
const findBookByIdIR: any = {"name":"FindBookById","params":[{"name":"commentId","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":58,"b":66,"line":2,"col":32}]},"isUsed":true}],"statement":{"body":"SELECT * FROM books WHERE id = :commentId","loc":{"a":26,"b":66,"line":2,"col":0}}};
...
const getBooksByAuthorNameIR: any = {"name":"GetBooksByAuthorName","params":[{"name":"authorName","required":true,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":724,"b":734,"line":37,"col":44}]},"isUsed":true}],"statement":{"body":"SELECT b.* FROM books b\r\nINNER JOIN authors a ON a.id = b.author_id\r\nWHERE a.first_name || ' ' || a.last_name = :authorName!","loc":{"a":611,"b":734,"line":35,"col":0}}};
...
const aggregateEmailsAndTestIR: any = {"name":"AggregateEmailsAndTest","params":[{"name":"testAges","required":false,"transform":{"type":"scalar"},"codeRefs":{"used":[{"a":829,"b":836,"line":40,"col":53}]},"isUsed":true}],"statement":{"body":"SELECT array_agg(email) as emails, array_agg(age) = :testAges as ageTest FROM users","loc":{"a":776,"b":858,"line":40,"col":0}}};
